...
resource "aws_glue_job" "etl_job" {
  name     = "ETL-datalake"
  role_arn = "arn:aws:iam::723963372483:role/ETL-job-Role" # Update with your IAM role ARN

  command {
    name            = "glueetl"
    python_version  = "3"
    script_location = "s3://aws-glue-assets-723963372483-us-east-1/scripts/ETL-datalake.py"
  }
